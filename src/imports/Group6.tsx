...
export default function Group6() {
  return (
    <div className="relative size-full">
      <Group />
      <div className="-translate-y-1/2 absolute hidden flex-col justify-center font-tagline leading-[0] left-[282px] not-italic text-[12px] text-black top-[165px] tracking-[1.5px] whitespace-nowrap md:flex">
